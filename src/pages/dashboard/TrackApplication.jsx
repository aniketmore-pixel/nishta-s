...
return ( <div className="container mx-auto px-4 py-8"> <div className="mb-8"> <h1 className="text-3xl font-bold text-primary mb-2">Track Your Applications</h1> <p className="text-muted-foreground">Monitor the status of all your loan applications</p> </div>
